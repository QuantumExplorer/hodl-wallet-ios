...
enum S {
    ...
    enum Scanner {
        static let flashButtonLabel = NSLocalizedString("Scanner.flashButtonLabel", value:"Camera Flash", comment: "Scan Groestlcoin address camera flash toggle")
    }
    ...
    enum SecurityCenter {
        ...
        enum Cells {
            ...
            static let paperKeyDescription = NSLocalizedString("SecurityCenter.paperKeyDescription", value:"The only way to access your Groestlcoin if you lose or upgrade your phone.", comment: "Backup Recovery Key button description")
    ...
    enum UpdatePin {
        ...
        static let caption = NSLocalizedString("UpdatePin.caption", value:"Remember this PIN. If you forget it, you won't be able to access your Groestlcoin.", comment: "Update PIN caption text")
    ...
    enum ReScan {
        ...
        static let footer = NSLocalizedString("ReScan.footer", value:"You will not be able to send Groestlcoin while syncing with the blockchain.", comment: "Sync blockchain view footer")
        static let alertTitle = NSLocalizedString("ReScan.alertTitle", value:"Sync with Blockchain?", comment: "Alert message title")
        static let alertMessage = NSLocalizedString("ReScan.alertMessage", value:"You will not be able to send Groestlcoin while syncing.", comment: "Alert message body")
    ...
    enum RequestAnAmount {
        static let title = NSLocalizedString("RequestAnAmount.title", value:"Request an Amount", comment: "Request a specific amount of Groestlcoin")
    ...
    enum MenuButton {
        ...
        static let buy = NSLocalizedString("MenuButton.buy", value:"Buy Groestlcoin", comment: "Buy Groestlcoin title")
    }
    ...
    enum Import {
        ...
        static let confirm = NSLocalizedString("Import.confirm", value: "Send %1$@ from this private key into your wallet? The Groestlcoin network will receive a fee of %2$@.", comment: "Sweep private key confirmation message")
    ...
    enum BitID {
        ...
        static let authenticationRequest = NSLocalizedString("BitID.authenticationRequest", value: "%1$@ is requesting authentication using your Groestlcoin wallet", comment: "<sitename> is requesting authentication using your Groestlcoin wallet")
    ...
    enum FeeSelector {
        ...
        static let satByte = NSLocalizedString("FeeSelector.satByte", value: "%1$@ gro/byte", comment: "Gros per byte")
        static let sat_byte = NSLocalizedString("FeeSelector.sat_byte", value: "gro/byte", comment: "Gros Per Byte")
