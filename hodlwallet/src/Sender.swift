...
class Sender {
    ...
    private func postProtocolPaymentIfNeeded() {
        ...
        request.setValue("application/groestlcoin-payment", forHTTPHeaderField: "Content-Type")
        request.addValue("application/groestlcoin-paymentack", forHTTPHeaderField: "Accept")
        ...
        URLSession.shared.dataTask(with: request as URLRequest) { data, response, error in
            ...
            if response.mimeType == "application/groestlcoin-paymentack" && data.count <= 50000 {
